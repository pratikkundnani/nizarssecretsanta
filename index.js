...
const introductionElement = createElementStyle(
  "div",
  `font-size:0em;position:absolute;text-align:center;transition:opacity 2s;width:250px`,
...
const restartButton = createElementStyle(
  "button",
  `width:0px;height:0px;position:sticky; top:50vh, left: 50vw;border-radius:50%;color:white;background-color:${colours.em};border:none;font-weight:700;font-size:1.2em;display:none;cursor:pointer`,
  "RESTART"
);
